...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    Draw.ResetLines(LineFrame)
        ...
        local d = page5:addSection("Made by: rblx-scripts.com#0031 and Auick#0163")
            ...
            local Discord = page5:addSection("Credits")
            local d = page5:addSection("Made by: rblx-scripts.com#0031")
            local d = page5:addSection("Scripter: rblx-scripts.com#0031")
...
local section1 = venyx:addPage("Main", 8162117119)
                    ...
                    -- load
                        ...
                        if game.PlaceId == 192800 then
                            local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/zxciaz/VenyxUI/main/Reuploaded"))() --someone reuploaded it so I put it in place of the original back up so guy can get free credit.
                            local venyx = library.new("Ez W Hub: Work At A Pizza Place", 5013109572)
...
local themes = {
 ...
 if game.PlaceId == 2377868063 then
    local library = loadstring(game:HttpGet("https://pastebin.com/raw/qwdPKKDN"))()
    local venyx = library.new("Ez W Hub: Strucid", 5013109572)
    ...
    local page = venyx:addPage("Aimbot", 8419290798)
    local section1 = page:addSection("Aimbot (If it not working reset")
    section1:addToggle("Silent Aim", nil, function (state)
        if state then
            print("Toggle On")
...
LocalPlayer.PlayerGui.ChildAdded:Connect(function(child)
    ...
    local Visuals = venyx:addPage("Visual", 8419618272)
    local section2 = Visuals:addSection("Esp")

    
    section2:addToggle("Box Esp", nil, function(state)
	if state then
        print("Toggle On")
--[[
A distribution of https://wearedevs.net/scripts
...
if not _G.WRDESPLoaded then    
    ...
    --Sets defaults where required
    if _G.WRDESPEnabled == nil then _G.WRDESPEnabled = false end
    if _G.WRDESPBoxes == nil then _G.WRDESPBoxes = false end
    if _G.WRDESPTeamColors == nil then _G.WRDESPTeamColors = false end
    if _G.WRDESPTracers == nil then _G.WRDESPTracers = false end
    ...
    _G.WRDESPLoaded = false
        ...
        local themes = {
            ...
            -- Theme page
            local settings = venyx:addPage("Settings", 8427894684)
            local colors = settings:addSection("Colors")
            local setting = settings:addSection("Settings")
